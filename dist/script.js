...
window.addEventListener('DOMContentLoaded', function () {
  var customizator = new _modules_customizator_customizator__WEBPACK_IMPORTED_MODULE_0__["default"]({// panelClass: 'customizator__panel', // default class
    // scaleOptions: {
    // btns: [
...
var Customizator = /*#__PURE__*/function () {
  ...
  _createClass(Customizator, [{
    ...
    value: function createPanel() {
      ...
      var allBtns = _toConsumableArray(this.scaleBtns);
